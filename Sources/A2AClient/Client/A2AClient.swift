...
// SendMessageRequest and SendMessageResponse live in A2ACore so both the
// client and server can use them as wire types. Re-exported via
// `@_exported import A2ACore` in A2AClientModule.swift.
